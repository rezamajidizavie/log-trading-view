      ...
      if (klines.length == 500) {
        ...
        if (totalKlines.length === 0) {
          ...
          return {
            ...
            c: totalKlines.map(b => Math.log(parseFloat(b[4]))),
            o: totalKlines.map(b => Math.log(parseFloat(b[1]))),
            h: totalKlines.map(b => Math.log(parseFloat(b[2]))),
            l: totalKlines.map(b => Math.log(parseFloat(b[3]))),
